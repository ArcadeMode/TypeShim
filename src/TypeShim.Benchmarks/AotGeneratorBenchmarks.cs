...
/// <summary>
/// Benchmarks for AOT generator builds
/// </summary>
[MemoryDiagnoser]
[MinColumn, MaxColumn, MeanColumn, MedianColumn]
public class AotGeneratorBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _setup.Validate();
        _executor = new GeneratorExecutor(_setup.AotGeneratorPath, _setup.ProjectRoot);
        _tempDir = Path.Combine(Path.GetTempPath(), "TypeShimBenchmark_AOT");
