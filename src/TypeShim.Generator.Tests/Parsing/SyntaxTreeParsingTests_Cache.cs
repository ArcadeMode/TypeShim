...
internal class SyntaxTreeParsingTests_Cache
{
    ...
    public void CSharpInteropClass_InstanceProperty_WithNullableUserClassType()
    {
        ...
        Assert.That(userClassInfo.Type.CSharpFullyQualifiedTypeSyntax.ToString(), Is.EqualTo("global::N1.MyClass"));
        ...
        Assert.That(p1PropertyInfo.Type.CSharpFullyQualifiedTypeSyntax.ToString(), Is.EqualTo("global::N1.MyClass?"));
