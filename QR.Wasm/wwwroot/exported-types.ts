...
export interface WasmModuleExports {
    QR: {
        Wasm: {
            Person: PersonInterop;
            PersonRepository: PersonRepositoryInterop;
            QRCode: QRCodeInterop;
            PersonName: PersonNameInterop;
        };
    };
}
...
export class PersonProxy implements Person {
    ...
    public GetName(): string {
        return this.interop.QR.Wasm.Person.GetName(this.instance);
    }

    public SetName(name: PersonName): void {
        return this.interop.QR.Wasm.Person.SetName(this.instance, name);
    }
...
export class PersonRepositoryProxy implements PersonRepository {
    ...
    public GetPerson1(): Person {
        return this.interop.QR.Wasm.PersonRepository.GetPerson1(this.instance);
    }

    public GetPerson2(): Person {
        return this.interop.QR.Wasm.PersonRepository.GetPerson2(this.instance);
    }
...
export class PersonRepositoryStatics {
    ...
    public GetInstance(): PersonRepository {
        return this.interop.QR.Wasm.PersonRepository.GetInstance();
    }
...
export class QRCodeStatics {
    ...
    public Generate(text: string, pixelsPerBlock: number): string {
        return this.interop.QR.Wasm.QRCode.Generate(text, pixelsPerBlock);
    }
