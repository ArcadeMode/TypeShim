...
export default function People() {
    ...
    <div>
        ...
        >
            Try switching between grid and list, so you can see the isolated effects of interop.
            The WASM layer caches the data, so only the initial render is affected by data fetching.
        </p>
