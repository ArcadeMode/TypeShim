...
""".Replace("{{typeName}}", typeName)));
    ...
    [Test]
    public void CSharpInteropClass_InstanceMethod_HasJSTypePromiseVoid_ForNullableVoidTaskParameterType()
    {
        SyntaxTree syntaxTree = CSharpSyntaxTree.ParseText("""
            using System;
            using System.Threading.Tasks;
...
""");
    ...
    [Test]
    public void CSharpInteropClass_InstanceProperty_HasJSTypePromiseVoid_ForVoidTaskPropertyType()
    {
        SyntaxTree syntaxTree = CSharpSyntaxTree.ParseText("""
            using System;
            using System.Threading.Tasks;
...
public partial class C1Interop
{
    ...
    public static object ctor([JSMarshalAs<JSType.Object>] JSObject jsObject)
    {
        return new C1()
        {
            P1 = (jsObject.GetPropertyAsVoidTask("P1") ?? throw new ArgumentException("Non-nullable property 'P1' missing or of invalid type", nameof(jsObject))),
        };
    }
    [JSExport]
