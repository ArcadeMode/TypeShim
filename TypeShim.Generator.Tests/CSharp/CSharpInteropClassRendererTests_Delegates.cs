...
""");
    ...
    [Test]
    public void CSharpInteropClass_Method_FunctionNullableUserClassReturnType()
    {
        SyntaxTree userClass = CSharpSyntaxTree.ParseText("""
            using System;
            using System.Threading.Tasks;
    ...
    public void CSharpInteropClass_Property_FunctionUserClassUserClassReturnType()
    {
        ...
        public partial class C1Interop
        {
            ...
            public static object ctor([JSMarshalAs<JSType.Object>] JSObject jsObject)
            {
                return new C1()
                {
                    P1 = (MyClass arg0) => MyClassInterop.FromObject(jsObject.GetPropertyAsJSObjectJSObjectFunctionNullable("P1") ?? throw new ArgumentException("Non-nullable property 'P1' missing or of invalid type", nameof(jsObject))(arg0)),
                };
            }
            [JSExport]
            [return: JSMarshalAs<JSType.Function<JSType.Any, JSType.Any>>]
